...
from vllm.distributed import (get_prefill_context_model_parallel_rank, get_dp_group,
...
class FusedMoEParallelConfig:
    ...
    @staticmethod
    def make(
        tp_size_: int, dp_size_: int, pcp_size_:int,
        ...
        use_ep = dp_size_ * tp_size_ * pcp_size_ > 1 and vllm_parallel_config.enable_expert_parallel
