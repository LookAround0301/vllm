...
class MultiDimKVCacheManager(KVCacheManager):
    ...
    # def get_blocks(self, request_id: str) -> MultiDimKVCacheBlocks:  # for baseline revert
    #     return MultiDimKVCacheBlocks(self.coordinator.get_blocks(request_id))

    def get_block_ids(self, request_id: str) -> tuple[list[list[list[int]]], ...]:
        return MultiDimKVCacheBlocks(
